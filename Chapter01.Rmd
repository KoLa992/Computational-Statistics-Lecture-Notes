...
- METRIC: Whether the data value reported is an average/mean ($\bar{y}$) or a median ($Me$).
...
Get the lognormal $\mu,\sigma$ parameters using the formula in Section 4.2.
...
And calculate the 90th percentile we are looking for with the `qlnorm` function.
...
Based on the plots we can conlude that...
