...
We can create a plot to see how well the theoretical normal distribution with the given $\mu$ mean and $\sigma$ standard deviation fits to the observed histogram.
...
## 3. Other Continuous Theoretical Distributions

TODO

## 4. Discrete Theoretical Distributions
