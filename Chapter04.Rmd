...
We'll apply MLE confidence intervals to answer the following question based on the 2024 European Social Survey data: *Is Party Peference Influenced by Internet Usage Time?*
...
Great, looks like we'll work with $n=1391$ observations! Now, to continue, we need to phrase our research question "*Is Party Peference Influenced by Internet Usage Time?*" a bit more explicitly.
