...
Great, we have that the $97\%$ confidence interval for this P99 is between $2$ and $11.67$. So, the upper bound is way larger than the observed maximum of 7. This means that based on our negative binomial distribution, **with $97\%$ confidence, we can very well imagine that the damage number above which only $1\%$ of villas have more damages is $11$**. Now, this high damage number is something that is more believable for Ákos Hadházy and his band of Grand Theft Auto players. :)
