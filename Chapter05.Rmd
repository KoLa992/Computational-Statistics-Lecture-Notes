...
Now, I think it comes as no surprise that these nice **GLRTs can also apply in multiple regression models** as well. So, let's circle back again to the multivariate regression model we estimated by classic OLS in <a href="Prelude05.html" target="_blank">Section 2 of Prelude 5</a>.
